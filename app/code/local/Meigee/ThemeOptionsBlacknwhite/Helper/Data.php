 ...
 public function isNew($product)
{
 ...
 public function prevnext ($product) {
	...
	public function setCookie() {
		...
		if ($generalSection['newsletter']['location'] == 0 or $generalSection['newsletter']['location'] == 2 or $generalSection['productlisting']['productsfilter'] == 1){
			return 'js/jquery.cookie.js';
		}
	}
	public function setSingleCookie() {
		$generalSection = $this->getThemeOptionsBlacknwhite('meigee_blacknwhite_general');
		if ($generalSection['newsletter']['location'] == 1 or $generalSection['productlisting']['productsfilter'] == 0){
